...
const PomodoroTimer = () => {
  ...
  return (
    <div className="timer-container">
      ...
      <p className="timer">
        {`${Math.floor(timerState.seconds / 60)}:${(timerState.seconds % 60)
          .toString()
          .padStart(2, "0")}`}
      </p>
      ...
      <div className="cycle-counter">
        <p className="completed">
          Завершено циклов: {timerState.cycleCount}
        </p>
